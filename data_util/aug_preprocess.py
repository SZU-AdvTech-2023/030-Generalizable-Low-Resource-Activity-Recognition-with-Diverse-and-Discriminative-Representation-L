...
if __name__ == "__main__":
    ...
    # raw_all_1, aug_all_1 = raw_to_aug(seed=args.seed, root_path="D:/xuxw/code/PyCharm/ddlearn-xw/data/process/",
    #                                   save_path="D:/xuxw/code/PyCharm/ddlearn-xw/data/process/", dataset='dsads', aug_num=7,
    #                                   remain_data_rate=0.8)
    # raw_all_2, aug_all_2 = raw_to_aug(seed=args.seed, root_path="D:/xuxw/code/PyCharm/ddlearn-xw/data/process/",
    #                                   save_path="D:/xuxw/code/PyCharm/ddlearn-xw/data/process/", dataset='uschad', aug_num=7,
    #                                   remain_data_rate=0.8)
    raw_all_3, aug_all_3 = raw_to_aug(seed=args.seed, root_path="D:/xuxw/code/PyCharm/ddlearn-xw/data/process/",
                                      save_path="D:/xuxw/code/PyCharm/ddlearn-xw/data/process/", dataset='pamap', aug_num=7,
                                      remain_data_rate=0.8)
    raw_all_4, aug_all_4 = raw_to_aug(seed=args.seed, root_path="D:/xuxw/code/PyCharm/ddlearn-xw/data/process/",
                                      save_path="D:/xuxw/code/PyCharm/ddlearn-xw/data/process/", dataset='hhar', aug_num=7,
                                      remain_data_rate=0.8)