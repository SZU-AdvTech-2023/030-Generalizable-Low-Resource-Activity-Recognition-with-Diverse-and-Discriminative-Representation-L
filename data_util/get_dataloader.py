...
def load(args):
    ...
    """
    data_path = args.root_path + 'process/' + \
        f'{args.dataset}/{args.dataset}_crosssubject_rawaug_rate{args.remain_data_rate}_t{args.target}_seed{args.seed}_scaler{args.scaler_method}.pkl'
