...
def load_raw_aug_data(raw_data, aug_data, scaler_method, dataset, target, n_domain):
    ...
    raw_tr_sx, raw_va_sx, raw_tr_tx, raw_va_tx, raw_te_tx, aug_tr_sx, aug_va_sx, aug_tr_tx, aug_va_tx, aug_te_tx = data_scaler(
        scaler_method,
        raw_tr_sx, raw_va_sx, raw_tr_tx, raw_va_tx, raw_te_tx, aug_tr_sx, aug_va_sx, aug_tr_tx, aug_va_tx, aug_te_tx,
        dataset)
...
if __name__ == "__main__":
    ...
    for args.dataset in ['hhar']:
        if args.dataset == 'dsads' or 'pamap' or 'hhar':
            n_domain = 4
        else:
            n_domain = 5
